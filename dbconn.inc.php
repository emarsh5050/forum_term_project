...
function dbConnect(){
	...
	$user = "erm2015_test"; // put your own user name here.
	$pwd = 'qmn43BTBFa2s'; // put your own database password here
	$database = "erm2015_termProject"; // put your database name here
